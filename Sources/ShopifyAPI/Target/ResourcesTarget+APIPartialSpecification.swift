...
extension ResourcesTarget {
  ...
  public struct APIPartialSpecification {
    public let shop: String
    let specMethod: APISpecificationMethod
    let page: Int?
    
    public static func getCount(from shop: String) -> APIPartialSpecification {
      return .init(shop: shop, method: .getCount)
    }
    
    public static func get(from shop: String) -> APIPartialSpecification {
      return .init(shop: shop, method: .get)
    }
    
    public static func get(from shop: String, at page: Int) -> APIPartialSpecification {
      return .init(shop: shop, at: page, method: .get)
    }
    
    public static func post(to shop: String) -> APIPartialSpecification {
      return .init(shop: shop, method: .post)
    }
    
    public static func put(to shop: String, id: String) -> APIPartialSpecification {
      return .init(shop: shop, method: .put(id: id))
    }
    
    public static func patch(to shop: String, id: String) -> APIPartialSpecification {
      return .init(shop: shop, method: .patch(id: id))
    }
    
    public static func delete(from shop: String, id: String) -> APIPartialSpecification {
      return .init(shop: shop, method: .delete(id: id))
    }
    
    private init(shop: String, at page: Int? = nil, method: APISpecificationMethod) {
      self.shop = shop
      self.page = page
